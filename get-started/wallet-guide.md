...
To get started on FRZDEX, the first thing you'll need is to set up a wallet that supports BNB Smart Chain (BSC). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with FRZDEX.
...
* Additional steps needed to use with BNB Smart Chain and FRZDEX
...
* No additional steps needed to use with BNB Smart Chain and FRZDEX.
...
To connect to BNB Smart Chain and use FRZDEX, you can follow the TokenPocket section of our Connect Your Wallet to FRZDEX guide [https://docs.FRZDEX.finance/get-started/connection-guide](https://docs.FRZDEX.finance/get-started/connection-guide).
...
This comparison table gives an overview of the most popular desktop wallets used with FRZDEX.
...
* Supports BNB Smart Chain by default, making using FRZDEX easy
* Supports a large number of languages
* Hardware wallet compatible
...
And that’s it, all done! You can follow our [Connect Your Wallet to FRZDEX guide](https://docs.FRZDEX.finance/get-started/connection-guide) to connect to BNB Smart Chain and FRZDEX.
{% endtab %}
{% endtabs %}
