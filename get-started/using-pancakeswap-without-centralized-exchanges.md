...
description: >-
  ...
  other centralized exchange to start using FRZDEX!
---

# Using FRZDEX without Centralized Exchanges

![](<../.gitbook/assets/how-to-FRZDEX-without-cex-header (1).png>)

FRZDEX is a decentralized application. That means, unlike Binance or other centralized platforms, you don't need to register account to use it... you just need a crypto wallet. So how can you get crypto onto FRZDEX without using a centralized exchange?

In this tutorial, we're going to guide you through the process of using "cross-chain bridges" to transfer your assets into your BNB Smart Chain wallet, and start using FRZDEX.
...
10. Once finished. You should receive your fund in your BSC wallet. Now you can start using FRZDEX to swap some tokens on BNB Smart Chain!
{% endtab %}
...
10. Once finished. You should receive your funds in your BSC wallet. Now you can start using FRZDEX to swap some tokens on BNB Smart Chain!
