# Connect Your Wallet to FRZDEX

![](../.gitbook/assets/how-to-connect-wallet-header.png)

You've made a wallet and gotten your BEP20 tokens, now you just need to connect your wallet with FRZDEX and you're good to go!

Check out the steps below for how to connect each of our recommended wallets to FRZDEX.
...
1. Scroll down to "Popular" and tap on "FRZDEX". You can also find it in "Exchanges".

![](../.gitbook/assets/image%20\(66\).png)

1. A new page will open with the FRZDEX logo and some information. Tap the **Connect** button.

![](../.gitbook/assets/image%20\(67\).png)

1. FRZDEX will open up. If you see a **Connect** button in the top-right tap that and tap **Trust Wallet** from the list.

{% hint style="warning" %}
If you find you are unable to connect at step 4, go back to the DApps menu and find "FRZDEX" again. Using "Pancake Swap" from the "History" section may result in the same problem.
{% endhint %}

#### iOS

To connect to FRZDEX through iOS, Trust Wallet have prepared a detailed guide on using WallteConnect.

Read the [Trust Wallet guide to connecting to FRZDEX via WalletConnect](https://community.trustwallet.com/t/using-walletconnect-to-access-FRZDEX/212307).
...
{% tab title="MetaMask" %}
![](../.gitbook/assets/image%20\(33\)%20\(3\)%20\(4\)%20\(5\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\).png)

To connect MetaMask to FRZDEX follow the steps below.
...
1. Type "FRZDEX" into the search field and start the search. The top result will be the FRZDEX exchange. Tap to enter it.
2. You wallet will ask you to connect. Tap **Connect** to connect to FRZDEX.
...
![](../.gitbook/assets/coinbase\_wallet\_wordmark\_blue%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\).png)
...
5. Type "FRZDEX.finance" into the search field and start the search.\
...
![](../.gitbook/assets/image%20\(125\)%20\(3\)%20\(4\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(3\).png)
...
1. You'll see a DApp browser page open. Under "Recommended", find and tap the **FRZDEX** button. If you can't see FRZDEX under Recommended, you can also find it under "BSC".

![](../.gitbook/assets/image%20\(79\).png)

1. A window will open saying that you will be opening a third party DApp. Tap **I got it** and you'll be taken to FRZDEX's website connected to your wallet.
...
1. You'll see a DApp browser page open. Under "DeFi", find and tap the **FRZDEX** button. If you can't see FRZDEX under DeFi, you can also find it under "BSC".

![](../.gitbook/assets/image%20\(83\).png)

1. A window will open saying that you will be opening a third party DApp. Tap **Confirm** and you'll be taken to FRZDEX's website connected to your wallet.
...
{% tabs %}
{% tab title="MetaMask" %}
![](../.gitbook/assets/image%20\(33\)%20\(3\)%20\(4\)%20\(5\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(4\).png)
...
1. Visit the [FRZDEX website](https://frzdex.finance). In the top right corner you'll see the **Connect** button. Click it.
...
![](../.gitbook/assets/image%20\(39\)%20\(1\).png)
...
1. Visit the FRZDEX website. In the top-right, click **Connect**.
...
{% tab title="Coinbase Wallet" %}
![](../.gitbook/assets/coinbase\_wallet\_wordmark\_blue%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(2\).png)
...
4. Visit the[ ](https://frzdex.finance)[FRZDEX.finance](https://frzdex.finance), In the top right corner you'll see the **Connect** button. Click it.\
...
{% tab title="Token Pocket" %}
![](../.gitbook/assets/image%20\(125\)%20\(3\)%20\(4\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(1\)%20\(2\).png)
...
1. On the list of BSC DApps, you'll find FRZDEX links. Click a **FRZDEX** link.

![](../.gitbook/assets/image%20\(92\).png)

{% hint style="warning" %}
Make sure you don't choose the "FRZDEX data analysis" option. If you do, you will not be able to connect.
{% endhint %}

1. Your browser will open a FRZDEX tab and attempt to connect to Token Pocket.
