...
To get started on your FRZDEX journey on Aptos, the first thing you'll need is to set up a wallet that supports Aptos Chain. Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
3 - Done! You can now deposit APT into the Aptos wallet and start using FRZDEX on Aptos by going to the "Discover" page!
...
This comparison table gives an overview of the most popular desktop wallets used with FRZDEX on Aptos
...
To start using FRZDEX on Aptos, you will also need to have some $APT tokens to pay gas fees. You can learn how to get some here.
{% endtab %}
...
4 - Done! Please note that you will need to fund your Aptos address with APT to start using FRZDEX on Aptos. If you want to access the same account on other devices, simply sign in using the same Email address.
{% endtab %}
{% endtabs %}
