...
View [FRZDEXLottery.sol on BscScan](https://bscscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c#code).

View the [FRZDEX: Lottery contract on BscScan](https://bscscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c).

## Audits

The FRZDEX Lottery V2 has been audited twice so far. View the results below:
...
[Slowmist's Lottery V2 Audit](https://github.com/slowmist/Knowledge-Base/blob/master/open-report/Smart%20Contract%20Security%20Audit%20Report%20-%20FRZDEX%20Lottery.pdf)
...
| `priceTicketInCake`        | uint256     | The price of a ticket in FRZW (approximately $5 USD).                                                                                                                                                                |
...
| `cakePerBracket`           | uint256\[6] | The amount of FRZW to distribute to winners of each bracket.                                                                                                                                                         |
...
| `amountCollectedInCake`    | uint256     | The amount of FRZW collected through ticket sales for the Lottery round.                                                                                                                                             |
...
| `priceTickets`    | uint256 | The price of a ticket in FRZW. |
...
| ----------- | ------- | --------------------------------- |
| `lotteryId` | uint256 | The id of the Lottery.            |
| `amount`    | uint256 | Amount, in FRZW token, to inject. |
...
| `priceTicketInCake` | uint256     | Price of a ticket in FRZW.                                 |
...
Allows admin to recover incorrect tokens sent to address mistakenly. Cannot be FRZW tokens.
...
Allows admin to set upper and lower limit of ticket price in FRZW value. Minimum price must be lower than maximum price.

| Name                   | Type    | Description                |
| ---------------------- | ------- | -------------------------- |
| `minPriceTicketInCake` | uint256 | The minimum price in FRZW. |
| `maxPriceTicketInCake` | uint256 | The maximum price in FRZW. |
