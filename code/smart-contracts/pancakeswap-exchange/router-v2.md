...
{% hint style="warning" %}
FRZDEX is based on Uniswap v2. Read the [Uniswap v2 documentation](https://docs.uniswap.org/protocol/V2/introduction).\
...
View [PancakeRouter.sol on GitHub](https://github.com/FRZDEX/FRZDEX-smart-contracts/blob/master/projects/exchange-protocol/contracts/PancakeRouter.sol).

**Binance smart chain**\
****Contract address**:** 0x10ED43C718714eb63d5aA57B78B54704E256024E\
View the [FRZDEX: Router v2 contract on BscScan](https://bscscan.com/address/0x10ed43c718714eb63d5aa57b78b54704e256024e).

**Ethereum mainnet**\
Contract address**:** 0xEfF92A263d31888d860bD50809A8D171709b7b1c\
View the [FRZDEX: Router v2 contract on Etherscan](https://etherscan.io/address/0xEfF92A263d31888d860bD50809A8D171709b7b1c).
