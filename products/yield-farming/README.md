...
Yield Farms allow users to earn FRZW while supporting FRZDEX by staking LP Tokens.
...
Learn [how to find Farm smart contracts](../../reference/how-to-use-farms-with-bscscan.md)
...
Why? Because when you stake your LP tokens in a farm to earn FRZW, you're still providing liquidity to the liquidity pool, so you earn LP rewards as well!
...
The **Farm Base APR** is calculated according to the farm multiplier and the total amount of liquidity in the farm -- this is the amount of FRZW distributed to the farm.
