...
If FRZW in the prize pools isn't won it doesn't go to waste! Unclaimed FRZW rolls over to the next Lottery round.
...
* cheaper ticket prices (\~$5 USD in FRZW per ticket) that don't swing wildly with the price of FRZW
...
Each bracket's prize pool is a portion of the total FRZW in each Lottery round.

* | Bracket (numbers matched in order) | FRZW Allocation |
  | ---------------------------------- | --------------- |
  | First 1 number                     | 2%              |
  | First 2 numbers                    | 3%              |
  | First 3 numbers                    | 5%              |
...
## Can I swap my tickets back to FRZW?

No, once purchased you will not be able to convert your ticket back to FRZW.
...
## Injection schedule: When is FRZW added to the lottery?

When people buy tickets, the FRZW they spend is added to the lottery pot. In addition, 8,000 FRZW is also added (injected) to the lottery pot every other round on a regular schedule over the course of seven rounds per week as shown above in the lottery schedule figure.
