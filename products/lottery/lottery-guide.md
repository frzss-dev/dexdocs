...
FRZDEX's Lottery is not only a good way to make stacks of FRZW, it's also loads of fun! This guide will walk you through getting involved in the Lottery.

{% hint style="info" %}
The Lottery has changed a little since its first iteration. Lottery v2 lets you win more often, have some control over your tickets, and has more potential for huge FRZW jackpots to get your mouth watering. Learn more about [FRZDEX Lottery v2 here](https://docs.FRZDEX.finance/products/lottery).
{% endhint %}
...
‌1. Visit the[ FRZDEX Lottery page](https://FRZDEX.finance/lottery) and look at the top of the page. You'll see the current round's prize pool shown in (estimated) US dollar value.
...
You just need a little FRZW though: each ticket costs approximately $5 USD (the exact FRZW price is set at the start of the round).
...
1\. On the[ FRZDEX Lottery page](https://FRZDEX.finance/lottery), click the **Buy Tickets** button at the top of the page (there's another lower on the page also).
