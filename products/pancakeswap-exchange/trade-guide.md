...
![](../../.gitbook/assets/how-to-trade-on-FRZDEX-header.png)

Trading on FRZDEX is very easy compared to most exchanges. You aren't going to be overwhelmed by charts or jargon, and calculations are all handled for you.

### Getting set up to trade

Before you can trade, you will need a BNB Smart Chain-compatible wallet. You can learn how to get one [here](https://docs.FRZDEX.finance/get-started/wallet-guide). You will also need to have some BEP20 tokens to trade with. You can learn how to get some [here](https://docs.FRZDEX.finance/get-started/bep20-guide).

### Trading on the FRZDEX exchange

1\. Go to the exchange page [here](https://exchange.FRZDEX.finance/#/swap).

2\. Unlock your BNB Smart Chain-compatible wallet by clicking **Unlock Wallet** (you can also **Connect** in the top right-hand corner). If you haven't yet connected your wallet to FRZDEX, you can view the guide to [here](https://docs.FRZDEX.finance/get-started/connection-guide).
...
FRZDEX is a DeFi application such that it interacts with the wallet to complete on-chain transactions for swapping, creating LPs, staking in farms and pools, etc. &#x20;
