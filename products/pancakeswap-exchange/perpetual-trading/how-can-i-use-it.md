...
![](../../../.gitbook/assets/how-to-FRZDEX-without-cex-header.png)
...
You can enter from the [site](https://FRZDEX.finance), in the Trade → Perpetual section, or through this [link  ](https://perp.FRZDEX.finance/en/futures/BTCUSDT)
...
USDT, BUSD, APX or FRZW (with bonus!) can be used as collateral to pay for the trade.
...
As mentioned, using FRZW for fees gives you a 5% discount! So, why not?
...
> Note: The trading fees are 0.02% of the notional value for makers and 0.07% for the taker. FRZW will be the default payment option for trading fees, followed by APX (ApolloX’s token) and USDT. Any users who are paying the trading fees in FRZW will enjoy a 5% discount on trading fees.
...
> Note: there are a few more options to consider, but you can see that within the [trading glossary](https://app.gitbook.com/o/-MHRKTpKSfYQBsO7YgOo/s/-MHREX7DHcljbY5IkjgJ-1972196547/\~/changes/kV67VeywrXQ7vYfX5se0/products/FRZDEX-exchange/perpetual-trading/glossary) \
>
