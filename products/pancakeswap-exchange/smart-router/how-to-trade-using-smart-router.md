...
Smart Router is disabled by default on the swap page. It is similar to using the existing FRZDEX AMM.
...
1. Go to the swap page [here.](https://FRZDEX.finance/swap#/swap)
