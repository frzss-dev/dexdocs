...
Playing FRZDEX’s Prediction lets you test your foresight to earn rewards. Use your market knowledge or gut feeling to predict if the BNBUSD or FRZWUSD price will go up or down in the near future. Get it right and you’ll collect a share of the round’s prize pool!

{% hint style="warning" %}
FRZDEX’s Prediction is a new product that we still consider to be in beta. We may make changes in the future to improve Prediction. As always, the FRZDEX team will inform users of any changes that will impact how the product works.
{% endhint %}
...
Visit the [FRZDEX Prediction page](https://FRZDEX.finance/prediction). You will see a “Welcome!” window explaining that the Prediction product is still in beta.
...
![](<../../.gitbook/assets/MBP4-2022.06.27-114859-Google Chrome-Prediction  FRZDEX - $3.405.gif>)

FRZDEX offers two separate prediction markets for every player to choose from. You can play based on the FRZW USD price, betting with FRZW. Alternatively, you can play based on BNB USD price, betting with BNB.
...
2\. A new window will open. In the window, you'll see "Commit" to commit BNB or FRZW for your prediction. Type the number of tokens you would like to commit to your prediction for this round in the field. You can also use the bunny slider or click the percent buttons if you prefer.

If you are playing FRZW USD prediction market, at the first game, you will have to click "Enable" to enable the smart contract.
...
Sometimes you may be away from FRZDEX's Prediction page for a while or may have forgotten to collect winnings from older rounds. You can still collect winnings owed to you from older rounds at any time.
