...
### What’s the FRZDEX Prediction contract address?
...
The treasury fee is currently set at 3%: this may be subject to changes, which would be announced on FRZDEX’s official communication channels. Treasury fees are used to buy back and burn FRZW tokens.

### **What are the fees?**

3% of each round's total pot will go to the treasury, which will be used to buyback and burn FRZW burn every Monday.

### What are you using for your price feed?

FRZDEX uses two sources for our price feeds. They each have their own purpose within the prediction market:
...
* Used for real-time price updates on the FRZDEX prediction market interface.&#x20;
...
In the very rare occurrence that the Locked Price is exactly the same as the Closed Price, no one wins, and all funds entered into positions will be sent to the treasury to be used for FRZW buybacks to burn.
...
### What causes FRZDEX Prediction market to pause?
